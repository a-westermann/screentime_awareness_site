...
SECRET_KEY = 'django-insecure-by2q8kl9a&tb_!)-r_*0s1#w_74_+1mzkyhn7qqi1_19^gmx_d' if not SECRET_KEY else SECRET_KEY
print(f'secret key {SECRET_KEY}')
DEBUG = os.getenv('DJANGO_SECRET_KEY') is None
